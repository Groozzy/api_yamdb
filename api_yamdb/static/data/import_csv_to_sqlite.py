...
category = pd.read_csv('api_yamdb/static/data/category.csv',
                       ...
                       index_col=0,
                       names=('id', 'name', 'slug'))
category.to_sql('reviews_categories', con, if_exists='replace', index_label='id')

genre = pd.read_csv('api_yamdb/static/data/genre.csv',
                    header=0,
                    index_col=0,
                    names=('id', 'name', 'slug'))
genre.to_sql('reviews_genres', con, if_exists='replace', index_label='id')
...
title.to_sql('reviews_titles', con, if_exists='replace', index_label='id')
...
genre_title.to_sql('reviews_titlesgenre',
                   con, if_exists='replace', index_label='id')
